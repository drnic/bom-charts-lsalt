...
abstract class MapAreaBase {
  // QLD-S, NSW-E
  gafAreaCode: string;
  gafArea: gafforecast.CommonArea;
  _uuid: string;
  _turfPolygon: turf.Feature<turf.Polygon, turf.Properties>;

  constructor(gafAreaCode: string, gafArea: gafforecast.CommonArea) {
...
export class MajorArea extends MapAreaBase {
  ...
  constructor(gafAreaCode: string, gafArea: gafforecast.Area) {
...
export class SubArea extends MapAreaBase {
  mapArea: MajorArea;
  gafSubArea: gafforecast.SubArea;
  ...
  constructor(mapArea: MajorArea, gafSubArea: gafforecast.SubArea) {
